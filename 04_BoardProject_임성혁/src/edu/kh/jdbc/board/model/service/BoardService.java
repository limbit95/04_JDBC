...
public class BoardService {
	 ...
	 * @return
	 */
	public int updateBoard2(String boardTitle, String commentContent, int boardNo) throws Exception{
		Connection conn = getConnection();
		
		int result = dao.updateBoard2(conn, boardTitle, commentContent, boardNo);
