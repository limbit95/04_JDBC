...
public class CommentView {
	...
	public void insertComment(int boardNo) {
		...
		try {
			int result = service.insertComment(boardNo, sb.toString(), loginMember.getMemberNo());
	...
	public void updateComment(int boardNo) {
		try {
			...
			int check = service.checkCommentNo(commentNo, boardNo, loginMember.getMemberNo());
			...
			System.out.println("[댓글 수정 내용 입력]<!wq> : ");
			StringBuffer sb = new StringBuffer();
